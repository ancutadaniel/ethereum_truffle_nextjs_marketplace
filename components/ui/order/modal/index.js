...
const createFormState = (
  ...
  if (!tos) {
    return _createFormState(true, 'You must accept the terms of service.');
  }
...
export default function OrderModal({
  ...
  const { pricePerCourse } = useETHPrice();
  ...
  const formState = createFormState(order, tos, isNewPurchase);
        ...
        <div className='bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4'>
          <div className='sm:flex sm:items-start'>
            <div className='mt-3 sm:mt-0 sm:ml-4 sm:text-left'>
                    ...
                    <label className='flex items-center mr-2'>
                      <input
                        ...
                        onChange={({ target: { checked } }) => {
                          setOrder({
                            ...order,
                            price: checked ? order.price : pricePerCourse,
                          });
              ...
              <div className='text-xs text-gray-700 flex mt-2'>
                <label className='flex items-center mr-2'>
                  <input
                    type='checkbox'
                    className='form-checkbox'
